...
// useEffect(() => {
//   if (isSignedIn) {
//     router.push("/dashboard"); // ⬅️ Your target route
//   }
// }, [isSignedIn, router]);

//   return (
//     <div className="grid w-full h-screen place-items-center px-4">
//       <SignIn.Root>
//         <Clerk.Loading>
//           {(isGlobalLoading) => (
//             <>
...
//                   <CardHeader>
//                     <CardTitle>Sign in to Summify</CardTitle>
...
//                         className="border-gray-500 text-white bg-blue-600 "
//                         >
...
//                       className="border-gray-500 text-white bg-gray-700"
//                       >
